class_name EnemyAttackState extends EnemyCombatState
...
func _get_facing_direction() -> String:
	...
	if actor and actor.has_method("get_facing_direction"):
		...
		print_debug("AttackState: get_facing_direction от Actor = ", dir)
		print_debug("AttackState: actor.velocity = ", actor.velocity)
		print_debug("AttackState: actor.last_facing_direction = ", actor.get("last_facing_direction"))
		return dir
	print_debug("AttackState: нет метода get_facing_direction, возвращаю down")
	return "down"
